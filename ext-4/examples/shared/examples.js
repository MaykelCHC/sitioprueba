Ext.example = function(){
    ...
    function createBox(t, s, url){
        ...
        return '<div class="msg"><img src="' + url + '" style="float: left; margin-right: 12px;" /><h3>' + t + '</h3><p>' + s + '</p></div>';
    }
    return {
        msg : function(title, format, url) {
        	console.log('---- format ----');
        	console.log(title);
        	console.log(format);
        	console.log(url);
            ...
            var m = Ext.DomHelper.append(msgCt, createBox(title, s, url), true);
            m.hide();
